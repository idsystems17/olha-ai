...
Todos os quatro achados 🟡 foram corrigidos, testados em dev com requisições reais contra o servidor rodando (não só leitura de código), e as contas de teste usadas foram apagadas depois.
